   ...
   // OJT Projects ---------------------------------------
    {
      ...
      imageLabels: ["User Dashboard", "User's Barcode Scanner", "User's Document Management", "User's Incoming Documents", "User's Personal Files", "User's Incoming Correspondence", "User's Outgoing Correspondence", "Admin Dashboard", "User Document", "Department Management", "Department Management", "Presets Management", "Stages Management", "Document type management", "File management", "Sytem Logs"],
      github: "#",
      demo: "#",
