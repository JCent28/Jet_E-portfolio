   ...
   // OJT Projects ---------------------------------------
    {
      ...
      images: ["img/user_dashboard.png", "img/user_barcode_scanner.png", "img/user_DM.png", "img/user_incoming_D.png", "img/user_PF.png", "img/user_IC.png", "img/user_OC.png", "img/admin_D.png", "img/admin_DM.png", "img/admin_DM2.png","img/user_Doc.png", "img/admin_PM.png", "img/admin_SM.png", "img/admin_DTM.png", "img/admin_FM.png", "img/admin_SL.png"],
      imageLabels: ["User Dashboard", "User's Barcode Scanner", "User's Document Management", "User's Incoming Documents", "User's Personal Files", "User's Incoming Correspondence", "User's Outgoing Correspondence", "Admin Dashboard", "Department Management", "Department Management", "Presets Management", "Stages Management", "Document type management", "File management", "Sytem Logs"],
      github: "#",
      demo: "#",
    ...
    },
    {
      ...
      images: ["🐾", "img/petDis1.png", "img/petDis2.png", "img/petDis3.png"],
      imageLabels: ["Pet Icon", "image 1", "Image 2", "Image 3"],
      github: "#",
      demo: "#",
      category: "IoT / Embedded Systems",
    },
